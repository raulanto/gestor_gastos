          ...
          children: [
            Row(
              children: [
                CircleAvatar(
                  ...
                  child: Icon(
                    IconUtils.getIcon(goal.iconCode),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Meta: ${CurrencyUtils.formatAmount(goal.targetAmount)}',
            ...
            txsAsync.when(
              data: (txs) {
                ...
                final progress = (savedAmount / goal.targetAmount).clamp(
                  0.0,
                  1.0,
                );
                ...
                return Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          CurrencyUtils.formatAmount(savedAmount),
                          style: theme.textTheme.titleMedium?.copyWith(
                            fontWeight: FontWeight.bold,
