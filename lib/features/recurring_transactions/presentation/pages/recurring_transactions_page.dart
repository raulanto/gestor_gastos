                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final nextDate = DateFormat(
                              'dd MMM yyyy',
                            ).format(DateTime.parse(rt.nextExecutionDate));

                            return InkWell(
                              onTap: () {
                                context.push(
                                  '/edit_recurring_transaction/${rt.id}',
                                );
                              },
                              onLongPress: () {
                                showDialog(
                                  ...
                                  builder: (ctx) => AlertDialog(
                                    ...
                                    content: const Text(
                                      '¿Estás seguro de que deseas eliminar este gasto recurrente? No se eliminarán los cobros ya generados.',
                                    ),
                                    actions: [
                                      TextButton(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          CurrencyUtils.formatAmount(rt.amount),
                                          style: theme.textTheme.titleMedium
                                              ?.copyWith(
                                                fontWeight: FontWeight.bold,
                                                color: isActive
